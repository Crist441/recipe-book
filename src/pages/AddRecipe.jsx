  ...
  return (
    ...
    >
      ...
      <p className="font-body text-sm text-muted-foreground mb-8">
        Fill in the details below. Add tips to each ingredient to help readers understand the dish better.
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
        <div className="sm:col-span-2">
          <label className="block text-[11px] font-body text-muted-foreground tracking-wider uppercase mb-1.5">
            Recipe Title *
          </label>
          <input
            value={form.title}
            onChange={(e) => updateField("title", e.target.value)}
            placeholder="e.g. Grilled Pork Tenderloin"
            className="w-full px-4 py-3 rounded-xl border border-border text-sm font-body bg-background focus:outline-none focus:ring-2 focus:ring-accent/40"
          />
        </div>
        <div className="sm:col-span-2">
          <label className="block text-[11px] font-body text-muted-foreground tracking-wider uppercase mb-1.5">
          ...
          <input
            ...
            placeholder="A brief tagline for this recipe"
            className="w-full px-4 py-3 rounded-xl border border-border text-sm font-body bg-background focus:outline-none focus:ring-2 focus:ring-accent/40"
          />
        </div>
        <div>
      ...
      <div className="mb-8">
        ...
        <input
          ...
          placeholder="e.g. Grilling, Summer, Vegetarian"
          className="w-full px-4 py-3 rounded-xl border border-border text-sm font-body bg-background focus:outline-none focus:ring-2 focus:ring-accent/40"
        />
      </div>
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-3">
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-accent text-accent-foreground text-sm font-body font-semibold px-4 py-2 rounded-lg hover:bg-accent/90 transition-colors"
          >
        ...
        <div className="grid grid-cols-12 gap-2 mb-1 px-0">
          {["Ingredient", "Amount", "Category", "Tip", ""].map((h, i) => (
            <span
              key={i}
              className={`text-[10px] uppercase tracking-wider text-muted-foreground font-body ${
      ...
      <button
        ...
        className="w-full bg-primary text-primary-foreground font-body font-bold text-base py-4 rounded-2xl hover:bg-accent transition-colors tracking-wide disabled:opacity-60 flex items-center justify-center gap-2"
      >
